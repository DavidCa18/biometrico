...
<%@page import="Controlador.ControladorAuditoria"%>
                                    ...
                                    <table id="example" class="table table-striped table-bordered table-hover" style="width: 100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="background: #3B93D1; color: white">Fecha Transacción</th>
                                                <th style="background: #3B93D1; color: white">Tabla</th>
                                                <th style="background: #3B93D1; color: white">Campo</th>
                                                <th style="background: #3B93D1; color: white">1er Registro</th>
                                                <th style="background: #3B93D1; color: white">Ult. Registro</th>
                                        ...
                                        <tbody>
                                            <%= controladorAuditoria.buscarAuditoria()%>
                                        </tbody>
                                    </table>
