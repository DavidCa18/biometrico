 ...
 * @author mario
 */
public class ServletEmpleadoGuardar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (controladorEmpleado.guardarEmpleado(empleado).equals("Empleado Guardado Exitosamente")) {
            response.getWriter().println("Empleado Guardado Exitosamente");
        } else {
            response.sendError(1, "Error al Guardar Empleado");
        }
