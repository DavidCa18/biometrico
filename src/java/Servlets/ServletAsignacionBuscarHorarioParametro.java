 ...
 * @author mario
 */
public class ServletAsignacionBuscarHorarioParametro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        for (Horario horario : controladorHorario.buscarHorarioParametrosModal(idHorario)) {
            ...
            JSONHorario
                    ...
                    + "\"espera_horario\":\"" + horario.getEsperaHorario()+ "\"\n"
                    + "},";
