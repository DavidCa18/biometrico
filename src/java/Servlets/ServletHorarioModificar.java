 ...
 * @author mario
 */
public class ServletHorarioModificar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int id = Integer.parseInt(request.getParameter("txtCodigoH"));
        ...
        if (controladorHorario.modificarHorario(horario).equals("Horario Modificado Exitosamente")) {
            response.getWriter().println("Horario Modificado Exitosamente");
        } else {
            response.sendError(1, "Error al Modificar Horario");
        }
    }
