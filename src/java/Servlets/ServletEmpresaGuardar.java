...
public class ServletEmpresaGuardar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (controladorEmpresa.guardarEmpresa(empresa).equals("Empresa Guardada Exitosamente")) {
            response.getWriter().println("Empresa Guardada Exitosamente");
        } else {
            response.sendError(1, "Error al Eliminar Empresa");
        }
    }
