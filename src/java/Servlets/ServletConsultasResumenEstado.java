 ...
 * @author mario
 */
public class ServletConsultasResumenEstado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        for (Terminal terminal : controladorConsulta.buscarHistorialResumenEstadoEmpleados(fechaInicio, fechaFin, empleados)) {

            JSONConsulta
                    += "{"
                    + "\"numero\":\"" + terminal.getIdTerminal() + "\",\n"
